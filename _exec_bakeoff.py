"""Execute Regression_Bakeoff.ipynb and print last cells' outputs."""
import sys, re, time
        ...
        if c.cell_type == "code":
            for out in c.get("outputs", []):
                if out.get("output_type") == "error":
                    ...
                    print(f"\n--- error in cell {i} ---\n{tb}")
    nbformat.write(nb, "Regression_Bakeoff.executed.ipynb")
    sys.exit(1)
...
nbformat.write(nb, "Regression_Bakeoff.executed.ipynb")
print("\nWrote Regression_Bakeoff.executed.ipynb")
