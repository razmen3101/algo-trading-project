"""Execute DBTS_NoBandit_EN_Regime.ipynb and print last cells' outputs."""
import sys, re, time
        ...
        if c.cell_type == "code":
            for out in c.get("outputs", []):
                if out.get("output_type") == "error":
                    ...
                    print(f"\n--- error in cell {i} ---\n{tb}")
    nbformat.write(nb, "DBTS_NoBandit_EN_Regime.executed.ipynb")
    sys.exit(1)
...
nbformat.write(nb, "DBTS_NoBandit_EN_Regime.executed.ipynb")
print("\nWrote DBTS_NoBandit_EN_Regime.executed.ipynb")
