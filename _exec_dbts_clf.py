"""Execute DBTS_Variants_Classifier.ipynb and print last cells' outputs."""
import sys, re, time
from pathlib import Path
import nbformat
from nbclient import NotebookClient

P = Path("DBTS_Variants_Classifier.ipynb")
        ...
        if c.cell_type == "code":
            for out in c.get("outputs", []):
                if out.get("output_type") == "error":
                    ...
                    print(f"\n--- error in cell {i} ---\n{tb}")
    nbformat.write(nb, "DBTS_Variants_Classifier.executed.ipynb")
    sys.exit(1)
...
nbformat.write(nb, "DBTS_Variants_Classifier.executed.ipynb")
print("\nWrote DBTS_Variants_Classifier.executed.ipynb")
