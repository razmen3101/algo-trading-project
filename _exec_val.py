"""Execute Regime_VAL.ipynb and print last cells' outputs."""
import sys, re, time
from pathlib import Path
import nbformat
from nbclient import NotebookClient

P = Path("Regime_VAL.ipynb")
        ...
        if c.cell_type == "code":
            for out in c.get("outputs", []):
                if out.get("output_type") == "error":
                    ...
                    print(f"\n--- error in cell {i} ---\n{tb}")
    nbformat.write(nb, "Regime_VAL.executed.ipynb")
    sys.exit(1)
...
nbformat.write(nb, "Regime_VAL.executed.ipynb")
print("\nWrote Regime_VAL.executed.ipynb")
