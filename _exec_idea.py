"""Execute Regression_Idea_Explained.ipynb and print last cells' outputs."""
import sys, re, time
from pathlib import Path
import nbformat
from nbclient import NotebookClient

P = Path("Regression_Idea_Explained.ipynb")
        ...
        if c.cell_type == "code":
            for out in c.get("outputs", []):
                if out.get("output_type") == "error":
                    ...
                    print(f"\n--- error in cell {i} ---\n{tb}")
    nbformat.write(nb, "Regression_Idea_Explained.executed.ipynb")
    sys.exit(1)
...
nbformat.write(nb, "Regression_Idea_Explained.executed.ipynb")
print("\nWrote Regression_Idea_Explained.executed.ipynb")
